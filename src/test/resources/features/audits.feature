Feature: Audits
  ...
  Scenario: Retrieve valid audit details successfully via UI
    ...
    """
   {"messageId":"ID:MH50012341-50432-1738159486534-7:1:1:1:1","flowId":"FLOW1047","flowName":"PURCHASEORDERRPA108","region":"MS","inboundQueue":"Activemq.PurchaseOrderrpa108.MS.IN","outboundQueue":"Activemq.PurchaseOrder109.MS.OUT","sourceTimeStamp":"2025-01-29 14:06:55:530","targetTimeStamp":"2025-01-29 14:06:55:941","stages":"INGATE.OUTGATE","inAuditStatus":"true","outAuditStatus":"true","payload":"{\r\n\"order_id\": \"012rpa\",\r\n\"customer_id\": \"67890\",\r\n\"address\": \"123 Main St, CapitalState\",\r\n\"region\":\"ME\",\r\n\"items\": [\r\n{\r\n\"name\": \"Widget\",\r\n\"quantity\": \"2\"\r\n},\r\n{\r\n\"name\": \"Gadget\",\r\n\"quantity\": \"1\"\r\n}\r\n]\r\n}\r\n\r\n\r\n\r\n\r\n\r\n"}
    """