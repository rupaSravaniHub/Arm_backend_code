...
//	http://localhost:9090/getReplay?flowId=FLOW1001&exceptionRoute=INGATE
	...
	public String getReplayById(@RequestParam("flowId") String flowId,
			@RequestParam("exceptionRoute") String exceptionRoute) {
		...
		String replayResponse = (String) producerTemplate.requestBodyAndHeader("direct:replayStatus", null,
				"CamelHttpResponse", String.class);
